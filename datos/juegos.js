...
window.CATALOGO_JUEGOS = [
  ...
  },
  {
    ...
    etiquetas: ["Palabras", "Por turnos", "Pistas"],
    jugadores: "2 jugadores",
    duracion: "5-10 min",
    dificultad: "Media",
    estado: "disponible",
  ...
  },
  {
    ...
    emoji: "🧠",
    descripcion:
      "Voltea cartas y encuentra parejas contra el reloj. Diseñado para jugar rápido, móvil y sin complicaciones.",
    categoria: "ingenio",
    categoriasExtra: ["familia", "clasicos"],
    etiquetas: ["Memoria", "Velocidad"],
    jugadores: "1 jugador",
    duracion: "3-6 min",
    dificultad: "Media",
    estado: "disponible",
